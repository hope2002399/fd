...
<body>
    ...
    <input type="hidden" name="type" id="type" value="template">
    <div class="row">
        <div class="span2">
           	<jsp:include page="conponent-select-basic.jsp"></jsp:include>
        </div>
        <div class="span10">
        ...
        <div class="span4">
     			<div style="font-size: 11px;font-weight: bold;font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">模版属性</div>
     			<br/>
     			<label><span class="label label-important">*</span>模板名称：</label>
											...
											success : function(data) {
												if ("error" == data.flag) {
													...
													if ("save" == type) { // 保存
														...
														var url = "/formdesign/formdesign/template-preview?templateId="
																+ data.template_id;
														window
																.open(
																		url,
