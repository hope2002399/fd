...
<div class="content">
    <table class="table table-bordered table-striped table-hover">
     		 <tr>
        	 <th colspan="2"  style="text-align: center;color: #b94a48;">以下为单选框选项配置</th>
        </tr>
        <tr>
        ...
        <tr>
        	 <th colspan="2" style="text-align: center;color: #b94a48;">以下为单选框隐藏域配置</th>
        </tr>
        <tr>
...
<script type="text/javascript">
    ...
    dialog.onok = function () {
		...
		if (!oNode) { // 新增
			...
			// tagType
			oNode.setAttribute('tagType', 'radio');
			oNode.innerHTML = taglabel + '，单选框：key=' + tagkey ;
		} else {
			opFlag = "edit";
		}
