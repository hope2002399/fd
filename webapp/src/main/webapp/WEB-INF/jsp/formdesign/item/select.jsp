...
<div class="content">
    <table class="table table-bordered table-striped table-hover">
     		 <tr>
        	 <th colspan="2"  style="text-align: center;color: #b94a48;">以下为下拉框选项配置</th>
        </tr>
        <tr>
        ...
        <tr>
        			<th colspan="2"><span>onchange</span></th>
        </tr>
         <tr>
           	 <td colspan="2"><input type="text" id="tagonchange" ></td>
        </tr>
        <tr>
            <th colspan="2">
        ...
        <tr>
        	 <th colspan="2" style="text-align: center;color: #b94a48;">以下为下拉框隐藏域配置</th>
        </tr>
        <tr>
...
<script type="text/javascript">
    ...
    dialog.onok = function () {
		...
		if (!oNode) { // 新增
			...
			// tagType
			oNode.setAttribute('tagType', 'select');
			oNode.innerHTML = taglabel + '，下拉框：key=' + tagkey ;
		} else {
			opFlag = "edit";
		}
